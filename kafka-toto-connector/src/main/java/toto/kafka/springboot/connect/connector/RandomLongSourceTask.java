...
import static toto.kafka.springboot.connect.util.RandomLongHttpClient.httpClient;
import static toto.kafka.springboot.connect.util.RandomLongSchemas.VALUE_SCHEMA;
...
public class RandomLongSourceTask extends SourceTask {
	...
	private List<SourceRecord> getSourceRecords() {
		SourceRecord record = new SourceRecord(null, null, topic, VALUE_SCHEMA, getRandomLongFromApi());
